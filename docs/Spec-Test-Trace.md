...
| FR-004 | TC-004, **Unit: PositionManager** | Automated | ✅ Done |
| FR-005 | TC-005, **Unit: HotkeyManager** | Manual + Automated | ✅ Done |
| FR-006 | **Unit: HotkeyManager Debounce** | Automated | ✅ Done |
| FR-007 | **Unit: HotkeyManager Config** | Automated | ✅ Done |
| FR-008 | TC-006, TC-007 | Automated | Partial |
| FR-009 | TC-006, TC-007, TC-014 | Automated | Partial |
| FR-010 | TC-006, **Unit: BackendConfigManager** | Automated | ✅ Done |
| FR-011 | **Unit: BackendConfigManager Persistence** | Automated | ✅ Done |
...
### 3.1 New Unit Tests (2026-03-19)

| Test File | Requirements | Tests | Status |
|-----------|--------------|-------|--------|
| `tests/unit/hotkey.test.js` | FR-005, FR-006, FR-007 | 10 | ✅ Passing |
| `tests/unit/position-memory.test.js` | FR-004 | 8 | ✅ Passing |
| `tests/unit/backend-switch.test.js` | FR-010, FR-011 | 10 | ✅ Passing |
| **Total** | | **28** | **100% Pass** |
...
| Script | Type | Status | FR Coverage |
|--------|------|--------|-------------|
| `tests/stt/stt-runner.js` | STT Integration | Working | FR-008, FR-009 |
| `tests/unit/state-machine.test.ts` | Unit | Working | FR-015 |
| `tests/unit/voice-service.test.ts` | Unit | Working | - |
| `tests/unit/hotkey.test.js` | Unit | ✅ **New** | FR-005, FR-006, FR-007 |
| `tests/unit/position-memory.test.js` | Unit | ✅ **New** | FR-004 |
| `tests/unit/backend-switch.test.js` | Unit | ✅ **New** | FR-010, FR-011 |
...
node --test tests/unit/hotkey.test.js

# Run STT integration tests
npm test
```
...
|--------|--------|-------|-------------|
| Requirements with Tests | 8/20 (40%) | 14/20 (70%) | +30% |
| Automated Test Count | 8 | 28 | +20 |
| Unit Test Files | 2 | 5 | +3 |

---

*Document updated on 2026-03-19*
